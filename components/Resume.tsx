...
const resumeContent: Content = {
  name: "Michael Terry",
  title: "AI Developer, Software Engineer, Full Stack Developrt",
  image: "/avatar.jfif",
  education_list: [
    {
      course: "Bachelor of Computer Science (Software Engineer & AI Developer)",
      institution: "The University of Texas at Austin",
      period: "Jan 2015 to Feb 2019",
      result: "",
      image: "/university_logo.png",
    },
    {
      course: "Master of Computer Science (AI Research & Full Stack Developer)",
      institution: "The University of Texas at Austin",
      period: "Apr 2019 to Jul 2021",
      result: "",
      image: "/university_logo.png",
    },
  ],
  ...
  social_list: [
    {
      name: "linkedin.com/in/michaelterry/",
      link: "https://www.linkedin.com/in/michaelterry/",
      icon: <LinkedInLogoIcon className="w-5 h-5" />,
    },
    {
      name: "github.com/terrydev0723",
      link: "https://www.github.com/terrydev0723/",
      icon: <GitHubLogoIcon className="w-5 h-5" />,
    },
    {
      name: "michaelterrydev@gmail.com",
      link: "mailto:michaelterrydev@gmail.com",
      icon: <EnvelopeClosedIcon className="w-5 h-5" />,
    },
    {
      name: "michaelterrydev.com",
      link: "https://www.michaelteerydev.net",
    ...
    <Card className={cn("w-full max-w-4xl")}>
      ...
      <CardFooter className="flex justify-end items-center p-6 bg-primary rounded-b-xl text-base">
        {/* <Button variant={"secondary"} asChild>
          <Link href="/terry-resume.pdf" download="terry-resume.pdf" target="_blank" rel="noreferrer" className="flex justify-center items-center">
    ...
    <Card className="bg-white h-[80vh] overflow-hidden overflow-y-scroll rounded-none border-none">
      ...
      <div className="space-y-6 py-6">
        ...
        <CardContent className="flex flex-col gap-4 py-0">
          ...
          <div className="flex flex-col gap-10 md:flex-row md:justify-left">
